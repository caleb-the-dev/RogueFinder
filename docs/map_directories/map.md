...
| Field | Value |
|---|---|
| last_updated | 2026-04-27 (armor mod — PHYSICAL_ARMOR_MOD/MAGIC_ARMOR_MOD Attribute enum values; transient `*_armor_mod` fields on CombatantData; stone_guard/divine_ward now mechanically active) |
