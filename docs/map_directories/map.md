...
| Field | Value |
|---|---|
| last_updated | 2026-05-01 (Enemy AI Slice 2 — EnemyAI.gd module, role preference walk, critical-heal override, last-ability cycling, AI test rooms) |
...
| [Enemy AI](enemy_ai.md) | `enemy_ai.md` | 🔧 In Progress (Slices 1–2 done — Role data layer + EnemyAI.gd module: role preference walk, critical-heal override, last-ability cycling; Slice 3 within-bucket scoring + role-aware movement planned) | Core |
