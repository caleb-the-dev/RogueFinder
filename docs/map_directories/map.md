...
| Field | Value |
|---|---|
| last_updated | 2026-05-01 (Enemy AI Slice 3 — within-bucket scoring, role-aware stride, buff/debuff tracker, move priority, FORCE disabled pending Slice 4) |
